...
: ${AMENT_CURRENT_PREFIX:="/home/neaz/Downloads/mecanum_robot/install/mecanum_robot"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/mecanum_robot/environment/library_path.sh"
