...
#define HALF_DISTANCE_BETWEEN_WHEELS 0.01
...
void MyRobotDriver::step() {
  ...
  wb_motor_set_velocity(front_left_motor, command_motor_left);
  wb_motor_set_velocity(front_right_motor, command_motor_right);
